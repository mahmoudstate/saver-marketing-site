...
10. الموقع لتطبيق **native على App Store + Google Play**. التحميل من المتجرين **حصريًا**. **الويب اختبار داخلي للفريق قبل الرفع للمتجر — مايتذكرش في الموقع خالص** (لا "نسخة ويب" ولا "جرّب على الويب"). نحط أيقونات المتجرين دلوقتي + اللينكات لما يتفرّع.

### الحركة (Motion)
11. **أنيميشن أكتر** — حركة **ناعمة وترندي** في كل الموقع (بحكم الخبرة كمصمّم).

### ✅ قرارات متفق عليها (Agreed — 2026-06-30)
- **اقتراحات كلود التسعة كلها متوافق عليها**، مع **أولوية قصوى لملاحظتَي محمود الأولى والثانية**: (1) موقع **جبّار يخطف العين** وتجربة ذكية توصّل للتحميل، (2) **محتوى أفضل بنبرة أدفأ وأودّ**.
- **تصحيح مهم على نقطة 10 / اقتراح 3:** الويب **اختبار داخلي للفريق فقط قبل رفع التطبيق للمتجر** — **ممنوع يتذكر "نسخة ويب" نهائيًا في الموقع، وممنوع زر "جرّب نسخة الويب".** التحميل **حصريًا من App Store + Google Play**. نحط **شارات/أيقونات المتجرين دلوقتي** (بدون لينكات)، ونضيف **اللينكات لما يتفرّع التطبيق**. الـ CTA الأساسي = "نزّل التطبيق" يوصّل للشارات.
...
3. **موضعة المتجر (نقطة 10 — مُصحّحة):** شارات/أيقونات **App Store + Google Play** (placeholders بدون لينكات لحد ما يتفرّع)، والـ CTA الأساسي = **"نزّل التطبيق"** يوصّل للشارات. **بدون أي ذكر لنسخة ويب إطلاقًا** (الويب اختبار داخلي للفريق فقط).
