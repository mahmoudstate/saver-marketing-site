...
const en: LandingCopy = {
  ...
  screen: {
    ...
    accounts: "Accounts", available: "Available", lockedGoals: "locked · goals", fullyAvailable: "Fully available",
    thisMonth: "Jul · This month", net: "Net", income: "Income", spent: "Spent", billsDue: "Bills · Jul", due: "due",
    billsTitle: "Bills", monthly: "Monthly", day: "Day", paid: "Paid", dueWord: "Due",
    goalsTitle: "Savings goals", savedToward: "Saved toward goals", twoActive: "2 active goals", frozenSafe: "frozen & safe",
    goalLaptop: "New laptop", goalHoliday: "Holiday", of: "of", frozenAndSafe: "Frozen and safe from spending", goalGo: "78% there",
    budgetsTitle: "Budgets", used: "used", spentOf: "spent of", budgetStandard: "Standard", leftOf: "left of",
    bdTitle: "Breakdown", totalSpent: "Total spent", across4: "across 4 categories", topCategories: "Top categories",
    bdFood: "Food & Dining", bdShopping: "Shopping", bdTransport: "Transport", bdFun: "Fun",
    enTag: "EN", arTag: "AR",
  },
};
...
const ar: LandingCopy = {
  ...
  screen: {
    ...
    accounts: "الحسابات", available: "المتاح", lockedGoals: "مجمّد · أهداف", fullyAvailable: "متاح بالكامل",
    thisMonth: "يوليو · هذا الشهر", net: "الصافي", income: "الدخل", spent: "المصروف", billsDue: "الفواتير · يوليو", due: "مستحقّة",
    billsTitle: "الفواتير", monthly: "شهري", day: "يوم", paid: "مدفوعة", dueWord: "مستحقّة",
    goalsTitle: "أهداف الادّخار", savedToward: "مُدّخر نحو الأهداف", twoActive: "هدفان نشطان", frozenSafe: "مجمّد وآمن",
    goalLaptop: "حاسوب جديد", goalHoliday: "إجازة", of: "من", frozenAndSafe: "مجمّد وآمن من الصرف", goalGo: "78% للهدف",
    budgetsTitle: "الميزانيات", used: "مُستخدَم", spentOf: "مصروف من", budgetStandard: "أساسية", leftOf: "متبقٍّ من",
    bdTitle: "التحليل", totalSpent: "إجمالي المصروف", across4: "عبر 4 فئات", topCategories: "أهم الفئات",
    bdFood: "الطعام", bdShopping: "التسوّق", bdTransport: "المواصلات", bdFun: "الترفيه",
    enTag: "EN", arTag: "AR",
  },
};
